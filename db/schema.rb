...
ActiveRecord::Schema.define(version: 20150227080322) do
  ...
  add_index "user_tasks", ["task_id", "user_id"], name: "index_user_tasks_on_task_id_and_user_id", unique: true, using: :btree
